package com.not.that.company.infrastructure.persistence;

import com.not.that.company.domain.*;
...
public class InMemoryPersistence implements AdRepository {
    ...
    public InMemoryPersistence() {
        ...
        pictures.add(new PictureVO(1, "http://www.not-that-company.com/pictures/1", "SD"));
        pictures.add(new PictureVO(2, "http://www.not-that-company.com/pictures/2", "HD"));
        pictures.add(new PictureVO(3, "http://www.not-that-company.com/pictures/3", "SD"));
        pictures.add(new PictureVO(4, "http://www.not-that-company.com/pictures/4", "HD"));
        pictures.add(new PictureVO(5, "http://www.not-that-company.com/pictures/5", "SD"));
        pictures.add(new PictureVO(6, "http://www.not-that-company.com/pictures/6", "SD"));
        pictures.add(new PictureVO(7, "http://www.not-that-company.com/pictures/7", "SD"));
        pictures.add(new PictureVO(8, "http://www.not-that-company.com/pictures/8", "HD"));
    }
