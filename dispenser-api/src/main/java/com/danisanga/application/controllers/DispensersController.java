...
import com.danisanga.application.responses.ValidationResponse;
import com.danisanga.application.validators.ChangeDispenserStatusValidator;
...
import com.danisanga.application.requests.DispenserChangeStatusRequestDTO;
import com.danisanga.application.requests.DispenserCreationRequestDTO;
...
import com.danisanga.application.validators.CreateDispenserValidator;
...
public class DispensersController {
    ...
    public DispenserStatsResponse getDispenserStats(@PathVariable final UUID dispenserId) {
        final DispenserStatsModel dispenserStats = dispenserService.getDispenserStats(dispenserId);
